...
const T = {
  en:{
    ...
    /* footer */
    f_tag:"A trading & logistics intermediary on the Iran–Kazakhstan corridor. Kazakhstan-based; Russian and English, with Persian for Iranian counterparties.",
    ...
    ab_p1:"Eurasia Bridge is a trade and logistics intermediary built around one corridor — Iran to Kazakhstan and the wider CIS. We handle the parts that usually take four separate companies: finding and vetting the supplier, moving the cargo by rail, ferry or road, clearing customs on both sides, settling payment — including barter where a clean cash channel is hard — and placing your goods on the shelf.",
    ab_p2:"We are based in Kazakhstan and work in Russian, English and Persian, so both sides of the deal speak to one accountable partner instead of a chain of handoffs.",
  ...
  ru:{
    ...
    f_tag:"Торгово-логистический посредник на коридоре Иран–Казахстан. База в Казахстане; русский и английский, персидский — для иранских контрагентов.",
  ...
  fa:{
    ...
    f_tag:"واسط تجاری و لجستیکی در کریدور ایران–قزاقستان. مستقر در قزاقستان؛ روسی و انگلیسی، و فارسی برای طرف‌های ایرانی.",
