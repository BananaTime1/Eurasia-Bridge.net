...
const T = {
  en:{
    ...
    h_sub:"We connect vetted suppliers and buyers across the corridor and help coordinate the whole deal — sourcing, transport, customs, payment and barter — from the supplier to the shelf.",
    h_cta1:"Open the route calculator", h_cta2:"Explore the routes",
    st1n:"3", st1l:"routes",
    st2n:"Free", st2l:"route quote",
    ...
    s2:"Multimodal logistics",s2d:"Rail, ferry and road, arranged through vetted carriers.",
    ...
    calc_sub:"Indicative only — our team confirms the real number once we've reviewed the lane and your details.",
    ...
    ct_title:"A clear route quote for your shipment.",
    ...
    ct_send:"Send enquiry", ct_note:"We reply as soon as we've reviewed your request.",
    p1b:"A real quote", p1t:"An indicative route and rough numbers, once we've reviewed your request.",
    ...
    /* footer */
    f_tag:"A sourcing & trade agent on the Iran–Kazakhstan corridor. Based in Kazakhstan and Iran; Russian and English, with Persian for Iranian counterparties.",
    ...
    vb_title:"Cargo moving, every day.", vb_sub:"Rail, ferry and road — one partner accountable from the gate to the shelf.", vb_groups:"product groups", vb_eyebrow:"The corridor, in motion", g_produce:"Fresh produce", g_constr:"Construction", ct_ok_t:"Thanks — enquiry received.", ct_ok_p:"We'll come back with an indicative route as soon as we've reviewed it.", net_eyebrow:"02 — The network", net_title:"Iran to every major CIS city.", net_sub:"Lanes from Iranian hubs — Tehran, Tabriz, Mashhad — to Moscow, Almaty, Astana, Tashkent, Baku and beyond.", nav_cargo:"Cargo", lst_eyebrow:"Cargo listings", lst_title:"Cargo on the corridor.", lst_sub:"Live lots offered both ways across the Iran–Kazakhstan corridor. Tap any to enquire.", lst_all:"All", lst_origin:"Origin", lst_moq:"Min. lot", lst_enquire:"Enquire", lst_add:"Anyone can add cargo — submissions appear here once our team approves them.", lst_empty:"No cargo listed yet — new lots appear here as they're added.",
    ...
    ab_p1:"Eurasia Bridge is a sourcing and trade agent built around one corridor — Iran to Kazakhstan and the wider CIS. We connect the two sides of a deal and coordinate the parts that usually take four separate companies: finding and vetting the supplier, arranging transport by rail, ferry or road through vetted carriers, clearing customs on both sides, settling payment — including barter where a clean cash channel is hard — and getting your goods onto the shelf. You work with one team on a transparent commission, not a chain of intermediaries.",
    ...
    ab_pt2_h:"Both-sides customs", ab_pt2_p:"EAEU certification and origin paperwork arranged on both borders through vetted brokers.",
  ...
  ru:{
    ...
    h_sub:"Мы связываем проверенных поставщиков и покупателей по коридору и помогаем координировать всю сделку — поиск поставщика, транспорт, таможня, платежи и бартер — от поставщика до полки.",
    h_cta1:"Открыть калькулятор", h_cta2:"Смотреть маршруты",
    st1n:"3", st1l:"маршрута",
    st2n:"Бесплатно", st2l:"расчёт маршрута",
    ...
    s2:"Мультимодальная логистика",s2d:"Ж/д, паром и автодорога — через проверенных перевозчиков.",
    ...
    calc_sub:"Предварительно — точную цифру пришлём после того, как изучим маршрут и детали.",
    ...
    ct_title:"Понятный расчёт маршрута под вашу отгрузку.",
    ...
    ct_send:"Отправить заявку", ct_note:"Ответим, как только изучим ваш запрос.",
    p1b:"Реальный расчёт", p1t:"Предварительный маршрут и ориентировочные цифры — после изучения запроса.",
    ...
    f_tag:"Торгово-закупочный агент на коридоре Иран–Казахстан. База в Казахстане и Иране; русский и английский, персидский — для иранских контрагентов.",
    ...
    ab_p1:"Eurasia Bridge — торгово-закупочный агент, построенный вокруг одного коридора: Иран — Казахстан и страны СНГ. Мы связываем две стороны сделки и координируем то, что обычно требует четырёх отдельных компаний: поиск и проверку поставщика, организацию перевозки по железной дороге, паромом или автотранспортом через проверенных перевозчиков, таможенное оформление с обеих сторон, расчёты — включая бартер, когда прямой денежный канал затруднён, — и вывод вашего товара на полку. Вы работаете с одной командой за прозрачную комиссию, а не с цепочкой посредников.",
    ...
    ab_pt2_h:"Таможня с обеих сторон", ab_pt2_p:"Сертификация ЕАЭС и документы о происхождении — на обеих границах, через проверенных брокеров.",
  ...
  fa:{
    ...
    h_sub:"ما تأمین‌کنندگان و خریداران معتبر را در طول کریدور به هم می‌رسانیم و در هماهنگی کل معامله کمک می‌کنیم — تأمین، حمل‌ونقل، گمرک، پرداخت و تهاتر — از تأمین‌کننده تا قفسه.",
    h_cta1:"باز کردن محاسبه‌گر مسیر", h_cta2:"کاوش مسیرها",
    st1n:"۳", st1l:"مسیر",
    st2n:"رایگان", st2l:"استعلام مسیر",
    ...
    s2:"لجستیک چندوجهی",s2d:"ریل، کشتی و جاده — از طریق شرکای حمل معتبر.",
    ...
    calc_sub:"فقط اولیه — عدد واقعی را پس از بررسی مسیر و جزئیات برای شما می‌فرستیم.",
    ...
    ct_title:"یک استعلام مسیر روشن برای محموله شما.",
    ...
    ct_send:"ارسال درخواست", ct_note:"به‌محض بررسی درخواست شما پاسخ می‌دهیم.",
    p1b:"استعلام واقعی", p1t:"مسیر اولیه و ارقام تقریبی — پس از بررسی درخواست شما.",
    ...
    f_tag:"کارگزار تأمین و تجارت در کریدور ایران–قزاقستان. مستقر در قزاقستان و ایران؛ روسی و انگلیسی، و فارسی برای طرف‌های ایرانی.",
    ...
    ab_p1:"پل اوراسیا یک کارگزار تأمین و تجارت است که حول یک کریدور شکل گرفته: ایران تا قزاقستان و کشورهای مشترک‌المنافع. ما دو طرف معامله را به هم می‌رسانیم و کارهایی را هماهنگ می‌کنیم که معمولاً به چهار شرکت جداگانه نیاز دارد: یافتن و ارزیابی تأمین‌کننده، ترتیب حمل بار با ریل، کشتی یا جاده از طریق شرکای حمل معتبر، ترخیص گمرکی در هر دو سو، تسویه — از جمله تهاتر وقتی کانال نقدی مستقیم دشوار است — و رساندن کالای شما به قفسه. شما با یک تیم و کارمزد شفاف کار می‌کنید، نه با زنجیره‌ای از واسطه‌ها.",
    ...
    ab_pt2_h:"گمرک در هر دو سو", ab_pt2_p:"گواهی EAEU و اسناد مبدأ — در هر دو مرز، از طریق کارگزاران معتبر.",
