...
const T = {
  en:{
    ...
    h_sub:"We connect vetted suppliers and buyers across the corridor and coordinate the whole deal — sourcing, transport, customs, payment and barter — from the supplier to the shelf.",
  ...
  ru:{
    ...
    h_sub:"Мы связываем проверенных поставщиков и покупателей по коридору и координируем всю сделку — поиск поставщика, транспорт, таможня, платежи и бартер — от поставщика до полки.",
  ...
  fa:{
    ...
    h_sub:"ما تأمین‌کنندگان و خریداران معتبر را در طول کریدور به هم می‌رسانیم و کل معامله را هماهنگ می‌کنیم — تأمین، حمل‌ونقل، گمرک، پرداخت و تهاتر — از تأمین‌کننده تا قفسه.",
